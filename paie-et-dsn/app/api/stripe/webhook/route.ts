      ...
      if (emailClient) {
        await envoyerEmail(
          ...
          [
            ...
            "",
            "Conformément à votre demande expresse exprimée lors de la souscription, l'exécution de votre abonnement (contenu numérique) commence immédiatement : vous avez en conséquence renoncé à votre droit de rétractation (article L. 221-28, 13° du Code de la consommation). Le présent e-mail confirme cet accord sur support durable.",
            "",
            "Votre abonnement est sans engagement et résiliable chaque mois (fonction en ligne : https://paie-et-dsn.fr/renoncer-au-contrat). Pour toute question, utilisez le formulaire de contact : https://paie-et-dsn.fr/contact",
            "",
            "Bien cordialement,",
