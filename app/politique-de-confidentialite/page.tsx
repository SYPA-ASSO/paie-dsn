      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-8 space-y-6 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">
              Ce site distingue deux catégories de cookies. Les cookies
              techniques (session, authentification de l&apos;espace client,
              sécurité du paiement) sont indispensables au fonctionnement du
              site et exemptés de consentement (délibération CNIL n°
              2020-091). La mesure d&apos;audience, assurée par Google
              Analytics avec adresses IP anonymisées, sans publicité ni suivi
              entre sites, n&apos;est activée qu&apos;avec votre accord
              préalable, recueilli par un bandeau à votre première visite ;
              votre choix est conservé 13 mois, puis vous est à nouveau
              demandé, et vous pouvez le modifier à tout moment via le lien
              « Gérer mes cookies » en pied de page. Les polices de caractères sont auto-hébergées : aucune
